...
void eSandBoxGame::_InitializeScene()
{
	...
	wallCube->GetTransform()->setTranslation(glm::vec3(3.0f, -1.0f, 3.0f));
	...
	soldier->GetTransform()->setTranslation(glm::vec3(0.0f, -2.0f, 0.0f));
	soldier->GetTransform()->setScale(glm::vec3(0.01f, 0.01f, 0.01f));
	...
	if (true)
	{
		...
		beam->GetTransform()->setTranslation(glm::vec3(0.0f, -1.5f, 6.0f));
		...
		crate->GetTransform()->setTranslation(glm::vec3(-15.f, -1.5f, -15.00f));
		...
		chair->GetTransform()->setScale(glm::vec3(.5f, .5f, .5f));
		...
		if (false)
		{
			...
			ship->GetTransform()->setTranslation(glm::vec3(0.0f, 0.0f, 0.0f));
	...
	if (false) // casle
	{
		...
		castle->GetTransform()->setTranslation(glm::vec3(1.0f, -2.0f, 2.0f));
		castle->GetTransform()->setScale(glm::vec3(0.2f, 0.2f, 0.2f));
	...
	if (false) //cottage
	{
		...
		cottage->GetTransform()->setTranslation(glm::vec3(0.5f, -2.01f, -2.0f));
		cottage->GetTransform()->setScale(glm::vec3(0.1f, 0.1f, 0.1f));
	...
	if (false) // mapleTree
	{
		...
		mapleTree->GetTransform()->setTranslation(glm::vec3(3.0f, -2.0f, -2.0f));
		mapleTree->GetTransform()->setScale(glm::vec3(0.1f, 0.1f, 0.1f));
