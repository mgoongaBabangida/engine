...
TerrainModel::TerrainModel(const TerrainModel& other):mesh(other.mesh), m_diffuse(other.m_diffuse), m_specular(other.m_specular), m_normal(other.m_normal), m_fourth(other.m_fourth), m_height(other.m_height)
{
