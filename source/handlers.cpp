...
void dbGLWindow::mouseMoveEvent(QMouseEvent* e)
{
...
void dbGLWindow::mouseReleaseEvent(QMouseEvent* e)
{
	inputController.OnMouseRelease();
	//camRay.release();
}

void dbGLWindow::keyPressEvent(QKeyEvent * e)
{
	inputController.OnKeyPress(e->key());
}

void dbGLWindow::mousePressEvent(QMouseEvent * e)
{
